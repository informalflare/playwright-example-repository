...
test.describe('Text Box', () => {
  ...
  test.describe('LEVEL 6', () => {
    /*
        ...
        We moved this into a  single Class (ui/po/elements/simple-input.el.ts)
        And using it as a single entity (ui/po/pages/text-box.po.ts) line 20.  Note: Check the selector
