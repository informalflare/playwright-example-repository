...
import {USER_0_DATA, USERS_LIST} from "@data";
/*
...
test.describe('Text Box', () => {
    test.describe('LEVEL 1', () => {
        ...
        test('Fill out ALL the form', async ({page}) => {
            ...
            //checking
            await expect(page.locator('div[id="output"]')).toHaveText('Name:RobertEmail:rob@gmail.comCurrent Address :str1 Permananet Address :str2')
        });
    ...
    test.describe('LEVEL 2', () => {
        ...
        2. We added the 'baseUrl' into the configuration file (playwright.config.ts)
    ...
    test.describe('LEVEL 3', () => {
        /*
        Level 3 Changes:
        1. We added a Page Object for text-box page ('src/po/pages/text-box.po.ts')
        In 'text-box.po.ts', for now you don't need to understand everything .
        Take a look at lines 9 - 16 for the moment.
        Result:
    ...
    test.describe('LEVEL 4', () => {
        ...
        a. Create a Page Object (example: 'src/po/pages/text-box.po.ts')
        b. Add it to the index file ('src/po/pages/index/ts')
        c. Add the fixture in fixture file ('src/fixtures/page-fixtures.ts')
    ...
    test.describe('LEVEL 6', () => {
        ...
        We moved this into a  single Class (src/po/elements/simple-input.el.ts)
        And using it as a single entity (src/po/pages/text-box.po.ts) line 20.  Note: Check the selector
    ...
    test.describe('LEVEL 8', () => {
        ...
        Changes:
        a) Created a new interface/type to group the arguments. (src/interfaces/example.int.ts) UserFormData
        b) Created a UserData file to store user data (src/data/example.data.ts) of a newly created type UserFormData
